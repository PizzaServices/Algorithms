...
namespace AlgorithmsTest.SortingTests
{
    public class MergeSortTest
    {
        ...
        public void TestBottomUp(int[] arrayToSort, int[] expected)
        {
            arrayToSort.SortBottomUp();
        ...
        [TestCase(1000)]
        [TestCase(10000)]
        public void TestRandomNumbersBottomUp(int count)
        {
        ...
        [TestCase(new[] { 2, 3, 1 }, new[] { 1, 2, 3 })]
        [TestCase(new[] { 23, 42, 4, 16, 8, 15, 3, 9, 55, 0, 34, 12, 2, 46, 25 }, new[] { 0, 2, 3, 4, 8, 9, 12, 15, 16, 23, 25, 34, 42, 46, 55 })]
        public void TestTopDown(int[] arrayToSort, int[] expected)
        {
            arrayToSort.SortTopDown();
            Assert.That(expected, Is.EquivalentTo(arrayToSort));
        }
        ...
        [TestCase(1000)]
        [TestCase(10000)]
        public void TestRandomNumbersTopDown(int count)
        {
            TimeSpan fileReading;
            TimeSpan sorting;
            Stopwatch watch = new Stopwatch();

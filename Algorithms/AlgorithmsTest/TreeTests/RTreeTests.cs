...
namespace AlgorithmsTest.TreeTests
{
    public class RTreeTests
    {
        ...
        public void RootLeafSplitWorks()
        {
            ...
            Assert.AreEqual(0, tree.Root.Envelope.MinX);
            Assert.AreEqual(0, tree.Root.Envelope.MinY);
            Assert.AreEqual(8, tree.Root.Envelope.MaxX);
            Assert.AreEqual(8, tree.Root.Envelope.MaxY);
            ...
            Assert.AreEqual(0, tree.Root.Envelope.MinX);
            Assert.AreEqual(0, tree.Root.Envelope.MinY);
            Assert.AreEqual(9, tree.Root.Envelope.MaxX);
            Assert.AreEqual(9, tree.Root.Envelope.MaxY);
        }
        ...
        public void InsertTestData()
        {
            ...
            Assert.AreEqual(points.OrderBy(x => x), tree.Search().OrderBy(x => x));
        ...
        public void TestSearchAfterInsert()
        {
            ...
            Assert.AreEqual(firstSet.OrderBy(x => x), tree.Search(firstSetEnvelope).OrderBy(x => x));
        }
